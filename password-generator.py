...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='darkblue', bg='WHITE', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='WHITE', fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='WHITE', fg='darkblue')
